                    ...
                    <div class="col-6 col-sm-6 col-md-3 col-lg-3" style="max-width: 20rem;">
                        <div class="card text-center rounded-lg" style="border: 0.125em solid #003958;">
                            ...
                            <div class="card-body">
                                ...
                                <a href="quienesSomos.php" class="btn btn-outline-primary btn-lg btn-block font-weight-bold"><small><strong>Ver más</strong></small></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-sm-6 col-md-3 col-lg-3" style="max-width: 20rem;">
                        <div class="card text-center rounded-lg" style="border: 0.125em solid #003958;">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
                                <a href="reflexiones.php" class="btn btn-outline-primary btn-lg btn-block font-weight-bold"><small><strong>Ver más</strong></small></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-sm-6 col-md-3 col-lg-3" style="max-width: 20rem;">
                        <div class="card text-center rounded-lg" style="border: 0.125em solid #003958;">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
                                <a href="noticias.php" class="btn btn-outline-primary btn-lg btn-block font-weight-bold"><small><strong>Ver más</strong></small></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-sm-6 col-md-3 col-lg-3" style="max-width: 20rem;">
                        <div class="card text-center rounded-lg" style="border: 0.125em solid #003958;">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
                                <a href="actividades.php" class="btn btn-outline-primary btn-lg btn-block font-weight-bold"><small><strong>Ver más</strong></small></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-sm-6 col-md-3 col-lg-3" style="max-width: 20rem;">
                ...
                <div class="row justify-content-center align-items-center mb-3">
                    ...
                    <div class="col-4 col-sm-4 col-md-4 col-lg-3 col-xl-3">
                        ...
                        <div class="txtInfo list-group list-group-flush">
                            <a href="quienesSomos.php" class="list-group-item list-group-item-action text-white" style="background: #003958;"><i class="fa-solid fa-arrow-right fa-xs mr-2"></i>Quiénes Somos</a>
                            <a href="reflexiones.php" class="list-group-item list-group-item-action text-white" style="background: #003958;"><i class="fa-solid fa-arrow-right fa-xs mr-2"></i>Reflexiones</a>
                            <a href="actividades.php" class="list-group-item list-group-item-action text-white" style="background: #003958;"><i class="fa-solid fa-arrow-right fa-xs mr-2"></i>Actividades</a>
<!--                            <a href="contacto_1.php" class="list-group-item list-group-item-action text-white" style="background: #003958;"><i class="fa-solid fa-arrow-right fa-xs mr-2"></i>Contáctenos</a>-->
                            <a href="contacto_2.php" class="list-group-item list-group-item-action text-white" style="background: #003958;"><i class="fa-solid fa-arrow-right fa-xs mr-2"></i>Contáctenos</a>
                        </div>
                    </div>
