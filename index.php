                ...
                <div class="row justify-content-around my-5">
                    <div class="card text-center rounded-lg mb-3" style="border: 0.125em solid #003958;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="quienessomos.php" class="btn btn-outline-primary btn-lg btn-block font-weight-bold">Ver más</a>
                        </div>
                    </div>
                    ...
                    <div class="card text-center rounded-lg mb-3" style="border: 0.125em solid #003958;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="reflexiones.php" class="btn btn-outline-primary btn-lg btn-block font-weight-bold">Ver más</a>
                        </div>
                    </div>
                    ...
                    <div class="card text-center rounded-lg mb-3" style="border: 0.125em solid #003958;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="noticias.php" class="btn btn-outline-primary btn-lg btn-block font-weight-bold">Ver más</a>
                        </div>
                    </div>
                    ...
                    <div class="card text-center rounded-lg mb-3" style="border: 0.125em solid #003958;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="actividades.php" class="btn btn-outline-primary btn-lg btn-block font-weight-bold">Ver más</a>
                        </div>
                    </div>
                    ...
                    <div class="card text-center rounded-lg mb-3" style="border: 0.125em solid #003958;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                <a href="contacto_1.php" class="btn btn-outline-primary btn-lg btn-block font-weight-bold"><small><strong>Ver más</strong></small></a>
<!--                            <a href="contacto_2.php" class="btn btn-outline-primary btn-lg btn-block font-weight-bold">Ver más</a>-->
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row justify-content-center mb-3">
                    ...
                    <div class="col-4 col-sm-4 col-md-4 col-lg-3 col-xl-3">
                        ...
                        <div class="txtInfo list-group list-group-flush">
                            <a href="quienessomos.php" class="list-group-item list-group-item-action text-white border-0" style="background: #003958;"><i class="fa-solid fa-arrow-right fa-xs mr-2"></i>Quiénes Somos</a>
                            <a href="reflexiones.php" class="list-group-item list-group-item-action text-white border-0" style="background: #003958;"><i class="fa-solid fa-arrow-right fa-xs mr-2"></i>Reflexiones</a>
                            <a href="noticias.php" class="list-group-item list-group-item-action text-white border-0" style="background: #003958;"><i class="fa-solid fa-arrow-right fa-xs mr-2"></i>Noticias</a>
                            <a href="actividades.php" class="list-group-item list-group-item-action text-white border-0" style="background: #003958;"><i class="fa-solid fa-arrow-right fa-xs mr-2"></i>Actividades</a>
                            <a href="contacto_2.php" class="list-group-item list-group-item-action text-white border-0" style="background: #003958;"><i class="fa-solid fa-arrow-right fa-xs mr-2"></i>Contáctenos</a>
                        </div>
                    </div>
        ...
        <!-- Ejecución del script de Javascript del preloader -->
        <script>
            function loader() {
        ...
        <!-- Ejecución del script de Javascript en PHP -->
        <?php
        echo "<script>";
        echo "loader()";
        echo "fadeOut()";
