                ...
                <div class="container bg-white rounded-lg" style="border: 0.25em solid #b59a47">
                    ...
                    <div class="row mb-3">                                            
                        <div class="col-12 col-lg-12 col-xl-6 col-6 mb-3">
                            ...
                            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="post" id="formulario" class="frmContacto needs-validation border border-dark-50 rounded-lg" novalidate style="background-color: #eee">
