...
<!-- Mensaje para confirmar y agradecer al usuario por su solicitud y sus comentarios -->
                ...
                <div class="row justify-content-center py-4">
                    <div class="d-flex flex-column">
                        ...
                        <div class="text-center py-3">
                            <h1 class="h1 mb-0 font-weight-bold">Su solicitud y comentarios fueron enviados con éxito</h1>
                        </div>
                        <div class="text-center py-3">
                            <h5 class="h5 mb-0">Nos pondremos en contacto con usted a la mayor brevedad posible</h5>
                        </div>
                        <div class="text-center py-3">
                            <img src="imagenes/LogoIglesiaColor.png" class="img-fluid w-25" alt="Logo sitio web iglesia">
                        </div>
                        <div class="text-center py-3">
