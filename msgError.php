...
<html lang="es">
    <head>
        ...
        <link href="estilos/msjCorreo.css" rel="stylesheet" type="text/css"/>
    ...
    <body class="fondoCorreo">
        <div class="colorFondo">
            <div class="container py-5">
                ...
                <div class="row justify-content-center py-4">
                    <h1 class="mb-0">Su solicitud y comentarios no pudieron ser enviados</h1>
                </div>
                <div class="row justify-content-center pb-5">
                    <h5 class="mb-0">Revisa tu conexión a internet y vuelve a enviar tu solicitud</h5>
                </div>        
                <div class="row justify-content-center py-4">
                    <img src="imagenes/LogoIglesiaColor.png" class="img-fluid" width="275" alt="Logo taller">
                </div>
                <div class="row justify-content-center py-4">
                    <a href="contacto_2.php" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Volver al formulario</a>
                </div> 
