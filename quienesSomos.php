                    ...
                    <nav class="menu collapse navbar-collapse border-top border-dark" id="navbarNav">
                        <ul class="nav nav-pills py-3" id="pills-tab" role="tablist">
                            <li class="nav-item mx-5" role="presentation">
                                <button class="nav-link active" id="pills-vision-tab" data-toggle="pill" data-target="#nuestraVision" type="button" role="tab" aria-controls="pills-vision" aria-selected="true"><i class="bi bi-globe2 pr-2"></i>Nuestra visión</button>
                            </li>
                            <li class="nav-item mx-5" role="presentation">
                                <button class="nav-link" id="pills-mision-tab" data-toggle="pill" data-target="#nuestraMision" type="button" role="tab" aria-controls="pills-mision" aria-selected="false"><i class="bi bi-flag-fill mr-2"></i>Nuestra misión</button>
                            </li>
                            <li class="nav-item mx-5" role="presentation">
                                <button class="nav-link" id="pills-perfil-tab" data-toggle="pill" data-target="#nuestroPerfil" type="button" role="tab" aria-controls="pills-perfil" aria-selected="false"><i class="bi bi-person-lines-fill mr-2"></i>Nuestro perfil</button>
                            </li>
                            <li class="nav-item mx-5" role="presentation">
                                <button class="nav-link" id="pills-estrategia-tab" data-toggle="pill" data-target="#nuestraEstrategia" type="button" role="tab" aria-controls="pills-estrategia" aria-selected="false"><i class="bi bi-list-check mr-2"></i>Nuestra estrategia</button>
                            </li>
                            <li class="nav-item mx-5" role="presentation">
                                <button class="nav-link" id="pills-vivencia-tab" data-toggle="pill" data-target="#nuestraVivenciaReino" type="button" role="tab" aria-controls="pills-vivencia" aria-selected="false"><i class="bi bi-cloud-sun-fill mr-2"></i>Nuestra vivencia del reino</button>
                            </li>
                            <li class="nav-item mx-5" role="presentation">
                                <button class="nav-link" id="pills-valores-tab" data-toggle="pill" data-target="#nuestrosValores" type="button" role="tab" aria-controls="pills-valores" aria-selected="false"><i class="bi bi-award-fill mr-2"></i>Nuestros valores</button>
                            </li>
                        ...
                        <div class="container bg-white rounded-lg contenido" style="border: 0.125em solid #b59a47">
                            <div class="row m-2 d-flex flex-column">
                                ...
                                <div class="d-flex flex-colum mb-3">
                                    <figure class="figure">
                                        <img src="imagenes/nuestraVision.jpg" class="figure-img img-fluid rounded-lg" alt="banner de la visión"/>
                                    </figure>                                    
                                    <div class="px-3 texto">
                    ...
                    <div class="imgFondoMagenta pt-4">
                        <div class="container bg-white rounded-lg contenido" style="border: 0.125em solid #b59a47">
                            <div class="row m-2 d-flex flex-column">
                                ...
                                <div class="d-flex flex-colum mb-3">                                    
                                    <figure class="figure">
                                        <img src="imagenes/nuestraMision.jpg" class="figure-img img-fluid rounded-lg" alt="banner de la misión"/>
                                    </figure>                                    
                                    <div class="px-3 texto">
                                        <p class="mb-1">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi eros lorem, sollicitudin quis lacus vel, imperdiet ornare neque. Aenean est justo, efficitur non erat et, faucibus cursus nibh. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nam convallis efficitur libero, sed malesuada arcu sodales a. Morbi viverra cursus nunc, vel sodales velit tincidunt a. Vestibulum leo urna, pharetra id mattis eget, lacinia vitae neque. Quisque mollis in ante in condimentum. Mauris vehicula iaculis velit, vel sagittis sem cursus sed. Fusce ultrices felis nec nisl tempor, vel iaculis nisi sodales. Nullam eget pellentesque enim, vitae interdum nunc. Nam odio nisl, suscipit at massa at, pellentesque lobortis felis.</p>
                                        <p class="mb-1">Etiam commodo, mauris at pulvinar sollicitudin, ligula magna rutrum ante, eu commodo nibh risus ut elit. Praesent mollis quam dolor, sit amet efficitur libero convallis eget. Praesent ac ex consequat, imperdiet orci id, imperdiet justo. Maecenas pharetra lacus non consectetur condimentum. Vestibulum bibendum libero iaculis dui faucibus porttitor. Aliquam in finibus orci, eget imperdiet metus. Suspendisse faucibus tortor id neque rutrum consectetur. Vestibulum non sollicitudin ligula.</p>
                    ...
                    <div class="imgFondoMorado pt-4">
                        <div class="container bg-white rounded-lg contenido" style="border: 0.125em solid #b59a47">
                            <div class="row m-2 d-flex flex-column mb-3">
                                ...
                                <div class="d-flex flex-colum mb-3">
                                    <figure class="figure">
                                        <img src="imagenes/nuestroPerfil.jpg" class="figure-img img-fluid rounded-lg" alt="banner del perfil"/>
                                    </figure>                                    
                                    <div class="px-3 texto">
                                        <p class="mb-1">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi eros lorem, sollicitudin quis lacus vel, imperdiet ornare neque. Aenean est justo, efficitur non erat et, faucibus cursus nibh. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nam convallis efficitur libero, sed malesuada arcu sodales a. Morbi viverra cursus nunc, vel sodales velit tincidunt a. Vestibulum leo urna, pharetra id mattis eget, lacinia vitae neque. Quisque mollis in ante in condimentum. Mauris vehicula iaculis velit, vel sagittis sem cursus sed. Fusce ultrices felis nec nisl tempor, vel iaculis nisi sodales. Nullam eget pellentesque enim, vitae interdum nunc. Nam odio nisl, suscipit at massa at, pellentesque lobortis felis.</p>
                                        <p class="mb-1">Etiam commodo, mauris at pulvinar sollicitudin, ligula magna rutrum ante, eu commodo nibh risus ut elit. Praesent mollis quam dolor, sit amet efficitur libero convallis eget. Praesent ac ex consequat, imperdiet orci id, imperdiet justo. Maecenas pharetra lacus non consectetur condimentum. Vestibulum bibendum libero iaculis dui faucibus porttitor. Aliquam in finibus orci, eget imperdiet metus. Suspendisse faucibus tortor id neque rutrum consectetur. Vestibulum non sollicitudin ligula.</p>
                    ...
                    <div class="imgFondoCafe pt-4">
                        <div class="container bg-white rounded-lg contenido" style="border: 0.125em solid #b59a47">
                            <div class="row m-2 d-flex flex-column">
                                ...
                                <div class="d-flex flex-colum mb-3">
                                    <figure class="figure">
                                        <img src="imagenes/nuestraEstrategia.jpg" class="figure-img img-fluid rounded-lg" alt="banner de la estrategia"/>
                                    </figure>                                    
                                    <div class="px-3 texto">
                                        <p class="mb-1">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi eros lorem, sollicitudin quis lacus vel, imperdiet ornare neque. Aenean est justo, efficitur non erat et, faucibus cursus nibh. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nam convallis efficitur libero, sed malesuada arcu sodales a. Morbi viverra cursus nunc, vel sodales velit tincidunt a. Vestibulum leo urna, pharetra id mattis eget, lacinia vitae neque. Quisque mollis in ante in condimentum. Mauris vehicula iaculis velit, vel sagittis sem cursus sed. Fusce ultrices felis nec nisl tempor, vel iaculis nisi sodales. Nullam eget pellentesque enim, vitae interdum nunc. Nam odio nisl, suscipit at massa at, pellentesque lobortis felis.</p>
                                        <p class="mb-1">Etiam commodo, mauris at pulvinar sollicitudin, ligula magna rutrum ante, eu commodo nibh risus ut elit. Praesent mollis quam dolor, sit amet efficitur libero convallis eget. Praesent ac ex consequat, imperdiet orci id, imperdiet justo. Maecenas pharetra lacus non consectetur condimentum. Vestibulum bibendum libero iaculis dui faucibus porttitor. Aliquam in finibus orci, eget imperdiet metus. Suspendisse faucibus tortor id neque rutrum consectetur. Vestibulum non sollicitudin ligula.</p>
                    ...
                    <div class="imgFondoAzul pt-4">
                        <div class="container bg-white rounded-lg contenido" style="border: 0.125em solid #b59a47">
                            <div class="row m-2 d-flex flex-column">
                                ...
                                <div class="d-flex flex-colum mb-3">
                                    <figure class="figure">
                                        <img src="imagenes/nuestraVivencia.jpg" class="figure-img img-fluid rounded-lg" alt="banner de la vivencia del reino"/>
                                    </figure>                                    
                                    <div class="px-3 texto">
                                        <p class="mb-1">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi eros lorem, sollicitudin quis lacus vel, imperdiet ornare neque. Aenean est justo, efficitur non erat et, faucibus cursus nibh. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nam convallis efficitur libero, sed malesuada arcu sodales a. Morbi viverra cursus nunc, vel sodales velit tincidunt a. Vestibulum leo urna, pharetra id mattis eget, lacinia vitae neque. Quisque mollis in ante in condimentum. Mauris vehicula iaculis velit, vel sagittis sem cursus sed. Fusce ultrices felis nec nisl tempor, vel iaculis nisi sodales. Nullam eget pellentesque enim, vitae interdum nunc. Nam odio nisl, suscipit at massa at, pellentesque lobortis felis.</p>
                                        <p class="mb-1">Etiam commodo, mauris at pulvinar sollicitudin, ligula magna rutrum ante, eu commodo nibh risus ut elit. Praesent mollis quam dolor, sit amet efficitur libero convallis eget. Praesent ac ex consequat, imperdiet orci id, imperdiet justo. Maecenas pharetra lacus non consectetur condimentum. Vestibulum bibendum libero iaculis dui faucibus porttitor. Aliquam in finibus orci, eget imperdiet metus. Suspendisse faucibus tortor id neque rutrum consectetur. Vestibulum non sollicitudin ligula.</p>
                    ...
                    <div class="imgFondoVerde pt-4">
                        <div class="container bg-white rounded-lg contenido" style="border: 0.125em solid #b59a47">
                            <div class="row m-2 d-flex flex-column">
                                ...
                                <div class="d-flex flex-colum mb-3">
                                    <figure class="figure">
                                        <img src="imagenes/nuestrosValores.jpg" class="figure-img img-fluid rounded-lg" alt="banner de los valores"/>
                                    </figure>                                    
                                    <div class="px-3 texto">
                                        <p class="mb-1">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi eros lorem, sollicitudin quis lacus vel, imperdiet ornare neque. Aenean est justo, efficitur non erat et, faucibus cursus nibh. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nam convallis efficitur libero, sed malesuada arcu sodales a. Morbi viverra cursus nunc, vel sodales velit tincidunt a. Vestibulum leo urna, pharetra id mattis eget, lacinia vitae neque. Quisque mollis in ante in condimentum. Mauris vehicula iaculis velit, vel sagittis sem cursus sed. Fusce ultrices felis nec nisl tempor, vel iaculis nisi sodales. Nullam eget pellentesque enim, vitae interdum nunc. Nam odio nisl, suscipit at massa at, pellentesque lobortis felis.</p>
                                        <p class="mb-1">Etiam commodo, mauris at pulvinar sollicitudin, ligula magna rutrum ante, eu commodo nibh risus ut elit. Praesent mollis quam dolor, sit amet efficitur libero convallis eget. Praesent ac ex consequat, imperdiet orci id, imperdiet justo. Maecenas pharetra lacus non consectetur condimentum. Vestibulum bibendum libero iaculis dui faucibus porttitor. Aliquam in finibus orci, eget imperdiet metus. Suspendisse faucibus tortor id neque rutrum consectetur. Vestibulum non sollicitudin ligula.</p>
